...
#ifndef _FLASH_ARRAY_H
#define _FLASH_ARRAY_H
 ...
 */
void picocart_flash_range_erase(uint32_t flash_offs, size_t count);
...
void picocart_flash_range_program(uint32_t flash_offs, const uint8_t *data, size_t count);
 ...
 */
void picocart_flash_do_cmd(const uint8_t *txbuf, uint8_t *rxbuf, size_t count);
