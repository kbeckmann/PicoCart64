...
#define PC64_REGISTER_SD_READ_SECTOR1 PC64_REGISTER_SD_READ_SECTOR0 + 0x2
#define PC64_REGISTER_SD_READ_SECTOR2 PC64_REGISTER_SD_READ_SECTOR1 + 0x2
#define PC64_REGISTER_SD_READ_SECTOR3 PC64_REGISTER_SD_READ_SECTOR2 + 0x2

// [WRITE] number of sectors to read from the sd card, 8 bytes
#define PC64_REGISTER_SD_READ_NUM_SECTORS PC64_REGISTER_SD_READ_SECTOR3 + 0x2
